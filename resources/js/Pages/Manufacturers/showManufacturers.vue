...
const manufacturer = computed( () => usePage().props.manufacturer )
    ...
    <MainLayout>
        ...
        <section>
            <div>
                ...
                <hr>
                <p><b>Descrição:</b> {{ manufacturer.dsManufacturer }}</p>
            </div>
            <div>
                <h2>
                    Produtos associados
                ...
                <hr>
                <p class="product-items" v-for="product in manufacturer.products">
